<template>
  <div class="shopcart" :class="{'hightLigh': totalCount > 0}">
    <div class="shopcart-wrapper">

      <!-- 底部左侧 -->
      <div class="content-left">
        <div class="logo-wrapper" :class="{'hightLigh': totalCount > 0}">
          <span class="icon-shopping_cart logo" :class="{'hightLigh': totalCount > 0}" @click="toggleList"></span>
        ...
        <div class="desc-wrapper">
          ...
          <p class="tip" :class="{'hightLigh': totalCount > 0}">另需{{poiInfo.shipping_fee_tip}}</p>
        </div>
      </div>
      
      <!-- 底部右侧 -->
      <div class="content-right" :class="{'hightLigh': totalCount > 0}">
        {{payStr}}
      </div>
...
.shopcart-wrapper .content-left .logo-wrapper.hightLigh {
  background: #ffd161;
}
.shopcart-wrapper .content-left .logo-wrapper .logo.hightLigh {
  color: #2d2b2a;
}
...
.shopcart-wrapper .content-left .desc-wrapper .tip.hightLigh {
  line-height: 12px;
}

.shopcart-wrapper .content-right.hightLigh {
  background: #ffd161;
  color: #2d2b2a;
}
