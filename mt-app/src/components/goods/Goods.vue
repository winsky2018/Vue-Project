<template>
  <div class="goods">
          ...
          <ul>
            <li v-for="(food, index) in item.spus" :key="index" class="food-item" @click="showDetail(food)">
              ...
              <div class="content">
                ...
                <p class="descr" v-if="food.description">{{food.discription}}</p>
                <div class="extra">
    ...
    <!-- 购物车 -->
    <app-shopcart :poiInfo = "poiInfo" :selectedFoods = "selectedFoods"></app-shopcart>
...
export default {
  ...
  methods: {
    ...
    selectMenu(index){
      ...
      //滚动到目标元素的位置
      this.foodScroll.scrollToElement(targetEle, 200)
      // console.log(index);
    },
    calculateCount(spus){
      let count = 0
